...
declare namespace WebResource {
	...
	class FormAccount extends DevKit.IForm {
		...
		*/
		...
		Body: WebResource.FormAccount.Body;
		/** The Header section of form Account */
		Header: WebResource.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: WebResource.FormAccount.Navigation;
		/** The QuickForm of form Account */
		QuickForm: WebResource.FormAccount.QuickForm;
		/** The Grid of form Account */
		Grid: WebResource.FormAccount.Grid;
	}
}
